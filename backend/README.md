...
## Project Structure
    ...
    ├── proxy_connectors_demo_3_3  # Django project configurations
...
1. Clone this repo and `cd proxy_connectors_demo_3_3`
...
2. Clone this repo and `cd proxy_connectors_demo_3_3`
